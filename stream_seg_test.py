       ...
       for result in results:
           ...
           if len(boxes):
               ...
               for box in boxes_np:
                   ...
                   center_y = (y1 + y2) // 2
                   # Draw center circle
                   cv2.circle(frame, (center_x, center_y), 4, (0, 0, 255), -1)  # Red dot
                   # Draw center crosshair
                   cv2.line(frame, (center_x - 5, center_y), (center_x + 5, center_y), (0, 0, 255), 1)
                   cv2.line(frame, (center_x, center_y - 5), (center_x, center_y + 5), (0, 0, 255), 1)
                   ...
                   cv2.putText(frame, center_text, (center_x + 10, center_y),
